...
public class Main extends Application {
    ...
    public static void main(String[] args) {
        ...
        ResourceConfig configuration = ResourceConfig.forApplicationClass(Main.class, HashSet.of(
                EventStore.class,
                ...
                com.fasterxml.jackson.jaxrs.json.JacksonJaxbJsonProvider.class*/).toJavaSet()
        );
